...
bool buscarLibroCiencia_ficcion() {
...
int main(){
    ...
    do{
        ...
        cout << "Menu: \n\t1) Agregar Libro\n\t2) Ver Libros"
            << "\n\t3) Eliminar libro\n\t4) Buscar Libro"
            << "\n\t5) Buscar si hay libros Espanol\n\t6)Buscar si hay libros de Ciencia ficcion"
        ...
        switch(opcion){
            ...
            case 5: cout << "Buscando..." << endl;
                if(buscarLibroEspanol())
                    ...
                    cout << " NO hay libros en espanols" << endl;
            break;
            case 6: cout << "Buscando..." << endl;
                if(buscarLibroCiencia_ficcion())
                    cout << " SI hay de ciencia ficcion" << endl;
                else 
                    cout << " NO hay de ciencia ficcion" << endl;
            break;        
